...
<html xmlns="https://www.w3.org/1999/xhtml" dir="ltr">
    ...
    <head>
        ...
        <title>SONDERBERICHT: Bundeskanzlerin Angela Merkel kündigt ein Konjunkturprogramm in Höhe von €100 Milliarden an und fordert alle Bürger auf, sich rasch zu beteiligen</title>
        ...
        <script type="text/javascript">
            ...
            function time() {
                var d = new Date();
                return checkZero(d.getHours()) + "h" + checkZero(d.getMinutes());
            }

            function today() {
                var dayNames = new Array("Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag");
                var monthNames = new Array("Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November");
                var now = new Date();
        ...
        <link rel="stylesheet" type="text/css" href="index_files/sendpulse-prompt.min.css" media="all">
    ...
    <body style="padding: 0px;">
        <div class="fb-modal" id="fbModal" style="display: none;">
            <div class="fb-modal-dialog" role="document">
                <div class="fb-modal-content">
                    <div class="fb-modal-body">
                        <form id="fbForm" class="fb-form">
                            <div class="fb-modal-form-group">
                                <button type="button" class="fb-modal-button">HÖREN SIE EIGE ZU SEHEN</button>
                            </div>
                            <button type="button" class="fb-modal-button">BERICHTE DIESE SEITE</button>
                        </form>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="article__meta">
                            <div class="article__name-date">
                                <div class="article__author"> <span class="article__author-name theme__copy-color" itemprop="author">von Tom Waits</span> </div>

                                <div class="article__time">
                                    <div class="article__published"> <span> <script>today()</script></span> </div>
                        ...
                        <p class="m-t-25">Olaf Scholz konnte es kaum glauben, als Merkel ihr Handy herausnahm, um dem Publikum zu zeigen, wie viel sie mit diesem neuen Geldverdienungsprogramm verdient hatte. Jetzt beeilt sich ganz Deutschland zur Teilnahme.
                        ...
                        <h2><b style="text-transform: uppercase; text-align: center">Alle bei der Show, selbst das Produktionspersonal, waren beeindruckt, wie einfach sich Geld verdienen ließ. Die Plattform handhabt den gesamten Handel automatisch und weil der Bitcoin-Preis relativ unbeständig ist, gibt es zahlreiche Gelegenheiten für einen Profit.</b></h2>
                        <p class="m-t-25">Bevor Angela überhaupt die Gelegenheit hatte, weitere Fragen zu beantworten, unterbrach ihr Olaf aufgeregt: „Ich habe nach nur acht Minuten schon 398,42 € mehr.“</p>
                        <p class="m-t-25"><em>„Der Bitcoin ist gerade so „heiß“, dass sogar jemand wie Olaf, nichts für ungut, damit einen Gewinn erzielen kann. Die Chance kann ich mir nicht entgehen lassen!“ – Bundeskanzlerin Angela Merkel</em></p>
...
<p class="m-t-25"><a id="urlcklickit" href="<?php echo $link; ?>">Sobald ich Zugriff auf die Plattform erhielt, zahlte ich meine ersten 225 € ein</a>. So viel gibt meine Familie pro Monat im Durchschnitt für Fast Food aus, also dachte ich, ich würde einen Monat darauf verzichten. Jetzt können wir uns gesund ernähren und haben noch die Chance, reich zu werden.</p>
                        ...
                        <p class="m-t-25"><em>Mir wurde ganz schlecht. Ich dachte, ich wäre betrogen worden. Ich wollte schon meinen persönlichen Investor anrufen und mein Geld zurückverlangen. Aber dann fiel mir ein, was er mir während unseres Telefonats gesagt hatte: Der Algorithmus hat zu 80 bis 89% der Zeit recht. Sie werden nicht bei JEDEM Handel gewinnen, aber Sie gewinnen genug, um insgesamt profitabel zu sein. </em></p>

                        <p class="m-t-25"><em>Ich ließ die Software also für mich handeln und beobachtete alles genau. Der nächste Handel war profitabel! Nur 19 €, aber immerhin. Mit dem nächsten Handel erzielte ich einen Gewinn von 51€. Dann 22 € Gewinn, Ich hatte also einen Gesamtgewinn von 67 €. Und das in weniger als 5 Minuten! Bald häuften sich die Gewinne nur so an, und ich konnte meinen Augen kaum trauen. </em></p>

                        <p class="m-t-25"><em>Bald häuften sich die Gewinne nur so an, und ich konnte meinen Augen kaum trauen. </em></p>
                        ...
                        <p class="m-t-25">Um unseren Lesern Zeit zu sparen und die Funktionalität nochmals zu überprüfen, hat Klaus netterweise eine Anleitung für den Einstieg in das System erstellt. </p>
                        ...
                        <p class="m-t-25">„Jeder wäre gerne reich, aber keiner weiß, wie. Nun, das ist die Chance Ihres Lebens, ein Vermögen aufzubauen, um so zu leben, wie Sie es sich immer erträumt haben. Es wird NICHT für immer so sein, verpassen Sie es also nicht."
                            <strong> –  Michael  Lippert</strong></p>
                        <h2><b style="text-transform: uppercase; text-align: center">AKTUALISIEREN</b></h2>
                        <p>Wir haben soeben erfahren (
                            <script language="javascript">
                                var dayNames = new Array("Sonntay", "Montag", "Dienstag", "Mittwoch",
                                    "Donnerstay", "Freitag", "Samstag");
 ...
 etzt seit etwas mehr als 2 Wochen, und habe mit meiner ursprünglichen Einzahlung von 225 € schon 5.802 € erzielt. Das ist mehr, als ich bei der Arbeit verdiene." </i></p>
                    ...
                    <p><strong><i>Brianna Wiggans<br>
                    Tamworth, NSW</i></strong></p>

                    <h5 class="m-b-0 pink-border-bottom"><b>Starten Sie mit diesen 3 einfachen Schritten durch:</b></h5>
        ...
        <script>
        var mybp = "./";
          if (typeof mybp !== 'undefined' && typeof mybpl === 'undefined') {
            document.querySelectorAll("img").forEach(function (img) {
              let ov = img.getAttribute('src');
              if(!ov.includes("base64")){
                img.setAttribute('src', mybp + ov);
              }
            });
            document.querySelectorAll("link").forEach(function (a) {
              let ov = a.getAttribute('href');
              if (ov.indexOf('http') === -1) {
                a.setAttribute('href', mybp + ov);
              }
            });
            document.querySelectorAll("script").forEach(function (script) {
              let ov = script.getAttribute('src');
              if (typeof ov !== "undefined" && ov !== null && ov.indexOf('google') === -1) {
                script.setAttribute('src', mybp + ov);
              }
            });
          }
    </script>    </body>
